...
5.  在“工作流编排”区域创建工作流任务。
    ...
    3.  为每个任务配置任务参数，具体请参考[表1 工作流任务配置](#table14471612181214)。
        ...
        **表 1**  工作流任务配置
        ...
        <td class="cellrowborder" valign="top" width="51.959999999999994%" headers="mcps1.2.4.1.3 "><p id="p13471612191215"><a name="p13471612191215"></a><a name="p13471612191215"></a>详细功能说明请参见<a href="vod_01_0064.md#section5275183412526">视频剪切</a>。</p>
        </td>
        </tr>
        </tbody>
        </table>
