...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=UpdateAssetCategory)中调试该接口。

## URI

PUT /v1.0/\{project\_id\}/asset/category
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>媒资分类名称。</p>
</td>
</tr>
