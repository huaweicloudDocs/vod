# 查询托管任务详情<a name="ShowTakeOverTaskDetails"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=ShowTakeOverTaskDetails)中调试该接口。

## URI

GET /v1.0/\{project\_id\}/asset/obs/host/stock/task/details
...
<a name="response_QueryTakeOverTaskDetailsRsp"></a>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Array of <a href="#response_AssetDetails">AssetDetails</a> objects</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>媒资信息。</p>
</td>
</tr>
</tbody>
</table>
