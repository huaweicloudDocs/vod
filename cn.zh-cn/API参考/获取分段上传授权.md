...
-   **处理成功时返回**
    ...
    **表 4**  处理成功返回参数
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="zh-cn_topic_0128109900_zh-cn_topic_0127940848_p20232144411316"><a name="zh-cn_topic_0128109900_zh-cn_topic_0127940848_p20232144411316"></a><a name="zh-cn_topic_0128109900_zh-cn_topic_0127940848_p20232144411316"></a>带授权签名字符串的URL。具体调用示例请参见<a href="示例2-媒资分段上传（20M以上）.md">示例2</a>。</p>
