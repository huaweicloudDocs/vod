...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=CancelAssetTranscodeTask)中调试该接口。

## URI

DELETE /v1.0/\{project\_id\}/asset/process
...
```
DELETE
https://{endpoint}/v1.0/{project_id}/asset/process?asset_id={asset_id}
```
