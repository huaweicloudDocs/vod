...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=CancelExtractAudioTask)中调试该接口。

## URI

DELETE /v1.0/\{project\_id\}/asset/extract\_audio
...
```
DELETE
https://{endpoint}/v1.0/{project_id}/asset/extract_audio?asset_id={asset_id}
```
