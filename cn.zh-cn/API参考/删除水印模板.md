# 删除水印模板<a name="DeleteWatermarkTemplate"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=DeleteWatermarkTemplate)中调试该接口。

## URI

DELETE /v1.0/\{project\_id\}/template/watermark
