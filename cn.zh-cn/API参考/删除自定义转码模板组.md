# 删除自定义转码模板组<a name="DeleteTemplateGroup"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=DeleteTemplateGroup)中调试该接口。

## URI

DELETE /v1.0/\{project\_id\}/asset/template\_group/transcodings
...
```
DELETE https://{endpoint}/v1.0/{project_id}/asset/template_group/transcodings?group_id={group_id}
```
