...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=PublishAssets)中调试该接口。

## URI

POST /v1.0/\{project\_id\}/asset/status/publish
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>发布的媒资信息。</p>
</td>
</tr>
</tbody>
</table>
