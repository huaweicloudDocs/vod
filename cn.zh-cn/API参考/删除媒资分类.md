...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=DeleteAssetCategory)中调试该接口。

## URI

DELETE /v1.0/\{project\_id\}/asset/category
...
<td class="cellrowborder" valign="top" width="85%" headers="mcps1.1.3.1.2 "><p>处理成功返回204 No Content。</p>
</td>
</tr>
