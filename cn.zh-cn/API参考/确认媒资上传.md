...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=ConfirmAssetUpload)中调试该接口。

## URI

POST /v1.0/\{project\_id\}/asset/status/uploaded
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>上传状态。</p>
<p>取值如下：</p>
<ul><li><p>CREATED：创建成功。</p>
</li><li><p>FAILED：创建失败。</p>
</li><li><p>CANCELLED：创建取消。</p>
</li></ul>
</td>
</tr>
</tbody>
