...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VOD&api=CreateTakeOverTask)中调试该接口。

## URI

POST /v1.0/\{project\_id\}/asset/obs/host/stock/task
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>源桶名。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>源目录名或源文件名。</p>
</td>
</tr>
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>suffix</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>否</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Array of strings</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>批量托管时的文件后缀名列表。不传或传空值时，表示托管所有音视频文件，不进行后缀名过滤。</p>
</td>
</tr>
...
<p>若不为空，则使用指定的转码模板对上传的音视频进行转码，您可以在视频点播控制台配置转码模板，具体请参见转码设置。</p>
...
<tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.1 "><p>host_type</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.2 "><p>否</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>表示音视频处理后生成的媒资文件所存储的位置类型。</p>
<p>取值如下所示：</p>
<ul><li><p>0：表示存储到点播桶。</p>
</li><li><p>1：表示存储在租户桶。</p>
</li><li><p>2：表示存储到租户桶，并且存储路径与源文件一致。</p>
</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>输出桶名，host_type为1时必选</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>输出路径名，host_type为1时必选</p>
</td>
</tr>
</tbody>
</table>
...
```
POST https://{endpoint}/v1.0/{project_id}/asset/obs/host/stock/task
